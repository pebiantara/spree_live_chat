var Juggernaut = function(options){
  ...
  this.io = io.connect(this.options.host + ":" + this.options.port)
...
Juggernaut.fn.publish = function(channel, msg){
  if ( !channel ) throw "Must provide a channel";
  var message = new Juggernaut.Message;
...
Juggernaut.fn.add_online = function(channel, msg){
  var message = new Juggernaut.Message;
  message.type = "online";
  message.channel = channel;
  message.data = msg;
...
Juggernaut.fn.get_online_users = function(channel, msg){
  var message = new Juggernaut.Message;
